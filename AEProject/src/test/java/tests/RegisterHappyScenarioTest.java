...
public class RegisterHappyScenarioTest extends BaseTest {
    @Test(dataProvider = "fullRegisterData", dataProviderClass = FakerDataProvider.class)
    public void register(String name, String email, String password, String company, String addr1, String addr2,
