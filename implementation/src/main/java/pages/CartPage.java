...
public class CartPage extends BasePage {
    ...
    public void proceedToCheckout() {
        this.wait.until((webDriver) -> ((JavascriptExecutor) webDriver)
                .executeScript("return document.readyState", new Object[0]).equals("complete"));

        WebElement checkoutBtnElement = (WebElement) this.wait
                .until(ExpectedConditions.elementToBeClickable(this.proceedToCheckoutButton));
    ...
    public void clickRegisterLogin() {
        ...
        WebElement registerLink = (WebElement) this.wait
                .until(ExpectedConditions.elementToBeClickable(this.registerLoginBtn));
    ...
    public void clickDeleteAccount() {
        this.wait.until((webDriver) -> ((JavascriptExecutor) webDriver)
                .executeScript("return document.readyState", new Object[0]).equals("complete"));
        WebElement deleteLink = (WebElement) this.wait
                .until(ExpectedConditions.elementToBeClickable(this.deleteAccount));
    ...
    public void deleteAllProducts() {
        while (this.driver.findElements(this.deleteButtons).size() > 0) {
            WebElement buttonToDelete = (WebElement) this.wait
                    .until(ExpectedConditions.elementToBeClickable(this.deleteButtons));
